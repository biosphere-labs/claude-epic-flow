...
This command updates the project context documentation in `workflow/context/` to reflect the current state of the project. Run this at the end of each development session to keep context accurate.
...
**File Modifications:**
- Check context file ages: `find workflow/context -name "*.md" -type f -exec ls -lt {} + | head -5`
...
- Context directory: `workflow/context/`
